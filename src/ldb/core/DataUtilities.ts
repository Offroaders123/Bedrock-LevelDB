...
export function getUnsignedShort(num1: number, num2: number, littleEndian: boolean) {
...
export function getUnsignedInteger(num1: number, num2: number, num3: number, num4: number, littleEndian: boolean) {
